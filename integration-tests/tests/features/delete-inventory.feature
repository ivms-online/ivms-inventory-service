...
Feature: Inventory management
    ...
    Scenario: Deleting inventory
        ...
        Then Inventory "test0" of type "pc" "key0" for vessel "00000000-0000-0000-0000-000000000000" of customer "00000000-0000-0000-0000-000000000001" does not exist
    ...
    Scenario: Deleting non-existing inventory
        ...
        Then Inventory "test1" of type "pc" "key0" for vessel "00000000-0000-0000-0000-000000000002" of customer "00000000-0000-0000-0000-000000000003" does not exist
